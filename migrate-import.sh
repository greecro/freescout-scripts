...
echo ""
echo -e "${BOLD}Wenn die UI leer/kaputt aussieht oder Module nicht laden:${NC}"
echo "  Manage → Modules → jedes Modul einmal deaktivieren + reaktivieren"
echo "  (Module registrieren sich dabei neu — behebt Darstellungsfehler nach Migration)"
echo ""
